        ...
        <div class="auth-card">
            <div class="auth-header">
                <div class="auth-header-content">
                    ...
                    <p class="text-purple-200 mt-2 text-sm sm:text-base">Sign in to your mySSL account</p>
                </div>
            </div>
            ...
            <div class="auth-body">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="divider">
                        <span class="divider-text">New to mySSL?</span>
                    </div>

                    <div class="text-center">
                        <p class="text-gray-600 text-sm">
                            Don't have an account? 
                            <a href="{{ route('show.register') }}" class="auth-link">Register here</a>
                        </p>
                    </div>
